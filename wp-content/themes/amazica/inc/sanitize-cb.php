 ...
 */
function amazica_sanitize_checkbox( $checked ) {
	// Boolean check.
 ...
 */
function amazica_sanitize_css( $css ) {
 ...
 */
function amazica_sanitize_dropdown_pages( $page_id, $setting ) {
 ...
 */
function amazica_sanitize_email( $email, $setting ) {
 ...
 */
function amazica_sanitize_hex_color( $hex_color, $setting ) {
	// Sanitize $input as a hex value without the hash prefix.
 ...
 */
function amazica_sanitize_html( $html ) {
 ...
 */
function amazica_sanitize_image( $image, $setting ) {
 ...
 */
function amazica_sanitize_nohtml( $nohtml ) {
 ...
 */
function amazica_sanitize_number_absint( $number, $setting ) {
 ...
 *                    the setting default.
 */
function amazica_sanitize_number_range( $number, $setting ) {
 ...
 */
function amazica_sanitize_select( $input, $setting ) {
 ...
 */
function amazica_sanitize_url( $url ) {
