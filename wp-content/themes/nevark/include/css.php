...
function nevark_dynamic_cssrules() {
	...
	hoot_add_css_rule( array(
						'selector'  => '#infinite-handle span' . ',' . '.lrm-form a.button, .lrm-form button, .lrm-form button[type=submit], .lrm-form #buddypress input[type=submit], .lrm-form input[type=submit]' . ',' . '.widget_newsletterwidget, .widget_newsletterwidgetminimal',
						'property'  => array(
							// property  => array( value, idtag, important, typography_reset ),
							'background' => array( $accent_color, 'accent_color' ),
							'color'      => array( $accent_font, 'accent_font' ),
	...
	hoot_add_css_rule( array(
						'selector'  => '.widget_newsletterwidget input[type=text], .widget_newsletterwidgetminimal input[type=text], .widget_newsletterwidget input[type=email], .widget_newsletterwidgetminimal input[type=email], .widget_newsletterwidget select, .widget_newsletterwidgetminimal select',
						'property'  => array(
							// property  => array( value, idtag, important, typography_reset ),
							'color'      => array( $accent_font, 'accent_font' ),
							),
