...
add_filter( 'hoot_custom_image_sizes', 'nevark_custom_image_sizes', 5 );
 ...
 * @return array
 */
function nevark_custom_image_sizes( $sizes ) {
	$sizes = array(
		...
		'hoot-medium-thumb' => array(
			'label'          => __( 'Medium Thumbnail', 'nevark' ),
			'width'          => 460,
			'height'         => 420,
			'crop'           => true,
		...
		'hoot-preview-thumb' => array(
			'label'          => __( 'Preview Thumbnail', 'nevark' ),
			'width'          => 465,
			'height'         => 600,
			'crop'           => true,
			'show_in_editor' => false,
		...
		'hoot-large-thumb' => array(
			'label'          => __( 'Large Thumbnail', 'nevark' ),
			'width'          => 690,
			'height'         => 550,
			'crop'           => true,
			'show_in_editor' => false,
