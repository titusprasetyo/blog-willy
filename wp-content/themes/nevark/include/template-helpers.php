...
function test_branding(){
	echo 'partial'; exit; nevark_branding();
}
/**
...
function nevark_get_text_logo( $nevark_logo, $tag_h1 = 'div', $tag_h2 = 'div' ) {
	...
	$class .= ( 'text' == $nevark_logo && !function_exists( 'nevark_premium' ) ) ? ' site-logo-text-' . hoot_get_mod( 'logo_size' ) : '';
	...
	$display .= '<div id="' . esc_attr( $id ) . '" class="' . esc_attr( $class ) . '">';
		...
		$display .= "<{$tag_h1} " . hoot_get_attr( 'site-title' ) . '>';
			$display .= '<a href="' . esc_url( home_url() ) . '" rel="home" itemprop="url">';
				...
				$title = ( 'custom' == $nevark_logo ) ? nevark_get_custom_text_logo() : get_bloginfo( 'name' );
...
function nevark_get_mixed_logo( $nevark_logo, $tag_h1 = 'div', $tag_h2 = 'div' ) {
	...
	$class .= ( 'mixed' == $nevark_logo && !function_exists( 'nevark_premium' ) ) ? ' site-logo-text-' . hoot_get_mod( 'logo_size' ) : '';
	...
	$display .= '<div id="' . esc_attr( $id ) . '" class="' . esc_attr( $class ) . '">';
		...
		$display .= '<div class="site-logo-mixed-text">';
			...
			$display .= "<{$tag_h1} " . hoot_get_attr( 'site-title' ) . '>';
				$display .= '<a href="' . esc_url( home_url() ) . '" rel="home" itemprop="url">';
					$title = ( 'mixedcustom' == $nevark_logo ) ? nevark_get_custom_text_logo() : get_bloginfo( 'name' );
					$display .= apply_filters( 'nevark_site_title', $title );
				$display .= "</a>";
			$display .= "</{$tag_h1}>";
