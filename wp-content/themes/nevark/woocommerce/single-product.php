...
nevark_add_custom_title_content( 'pre', 'single-product.php' );
if ( nevark_titlearea_top() ) {
	...
	nevark_add_custom_title_content( 'post', 'single-product.php' );
}

// Template modification Hook
do_action( 'nevark_before_content_grid', 'single-product.php' );
?>
...
<div class="hgrid main-content-grid">
	...
	<main <?php hoot_attr( 'content' ); ?>>
		<div <?php hoot_attr( 'content-wrap', 'single-product' ); ?>>
			...
			<?php
			// Template modification Hook
			do_action( 'nevark_main_start', 'single-product.php' );
			...
			<?php if ( have_posts() ) : ?>
				...
				// Template modification Hook
				do_action( 'nevark_loop_start', 'single-product.php' );
				?>
				...
				<?php
				// Template modification Hook
				do_action( 'nevark_loop_end', 'single-product.php' );

				// Template modification Hook
				do_action( 'nevark_after_content_wrap', 'single-product.php' );
				?>
			...
			// Template modification Hook
			do_action( 'nevark_main_end', 'single-product.php' );
			?>
