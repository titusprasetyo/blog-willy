 ...
 * @return int
 */
if ( !function_exists('nevark_woo_loop_per_page') ) :
function nevark_woo_loop_per_page( $value ) {
	return intval( hoot_get_mod( 'wooshop_products' ) );
}
endif;
add_filter( 'loop_shop_per_page', 'nevark_woo_loop_per_page', 20 );
 ...
 * @return int
 */
if ( !function_exists('nevark_woo_loop_columns') ) :
function nevark_woo_loop_columns( $value ) {
	return intval( hoot_get_mod( 'wooshop_product_columns' ) );
}
endif;
add_filter( 'loop_shop_columns', 'nevark_woo_loop_columns', 999 );
 ...
 * @return void
 */
if ( !function_exists('nevark_woo_custom_loop_columns_css') ) :
function nevark_woo_custom_loop_columns_css() {
...
add_action( 'wp_enqueue_scripts', 'nevark_woo_custom_loop_columns_css', 99 );
